...
describe('DatabaseService', () => {
  ...
  describe('connect', () => {
    ...
    it('should throw DatabaseConnectionError when host is missing', async () => {
      ...
      await expect(service.connect()).rejects.toThrow('Missing required database configuration');
    });
    ...
    it('should throw DatabaseConnectionError when connection test fails', async () => {
      ...
      await expect(service.connect()).rejects.toThrow(DatabaseConnectionError);
      await expect(service.connect()).rejects.toThrow('Failed to connect to the database');
    });
  ...
  describe('getKnex', () => {
    ...
    it('should throw DatabaseConnectionError when not connected', () => {
      ...
      expect(() => service.getKnex()).toThrow('Database not connected. Call connect() first.');
    });
  });
