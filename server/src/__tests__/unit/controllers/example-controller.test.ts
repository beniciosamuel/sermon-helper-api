...
describe('ExampleController', () => {
  ...
  describe('getData', () => {
    it('should return 200 with data when service succeeds', async () => {
      ...
      // Act
      await controller.getData(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  describe('createData', () => {
    it('should return 201 with created data when service succeeds', async () => {
      ...
      // Act
      await controller.createData(mockRequest as Request, mockResponse as Response, mockNext);
